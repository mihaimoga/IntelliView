...
***Ask not what IntelliView can do for you - ask what you can do for IntelliView***
...
2. Include additional information such as:
    ...
    * IntelliView Debug-Info containing:
...
1. Respect existing IntelliView coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
